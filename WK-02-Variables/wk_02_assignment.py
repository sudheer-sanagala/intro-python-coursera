...
Complete the body of the function so that it returns the right number. Note: Since division by 0 produces an error,
...
def fractional_part(numerator, denominator):
    ...
    if denominator  > 0:
        ...
        return val - int(val)  # returns decimal parts
    return 0
